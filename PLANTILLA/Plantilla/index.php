...
<body>
                     ...
                     <div class="card">
                        <div class="header">
                           ...
                           <form name="envia" method="POST" enctype="multipart/form-data">
                              ...
                              <!--<button onclick="subir()" type="button" class="btn btn-primary form-control">cargar</button>-->
                           </form>
                        </div>
               ...
               <nav class="pull-left">
                  <p class="copyright pull-right">
                     ...
                     <?php
                        ...
                        $pdo = new db();
                        $total_alumnos = $pdo->mysql->query("select count(id) from alumno");
                        foreach ($total_alumnos as $total_alumnos) {
                           echo $total_alumnos['count(id)'];
                        }
                        */
                     ?>
   ...
   <script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js" language="JavaScript" type="text/javascript"></script>
...
<script type="text/javascript">
   $(document).ready(function () {
      ...
      var data = {
         series: [<?php echo total_isc() . ', '. total_ige(). ', '. total_idc();?>]
      };
      ...
      new Chartist.Pie('.dato', data, {
         labelInterpolationFnc: function (value) {
               return Math.round(value / data.series.reduce(sum) * 100) + '%';
         }
      });
      var data1 = {
         series: [<?php echo total_hombres().', '. total_mujeres() ?>]
      };
   ...
   /**       $.notify({
         icon: 'pe-7s-gift',
         message: "Tienes acciones <b>importantes que</b> realizar."
